(import ./../reflex-platform {}).project ({ pkgs, ... }:
{
  ...
  packages = {
    common           = ./common;
    node-editor      = ./frontend/node-editor;
    node-editor-view = ./frontend/node-editor-view;
  };
  ...
  in {
    ...
    frontend-common            = dontCheck (doJailbreak (self.callCabal2nix "frontend-common"           ./frontend/lib                     {}));
    luna-api-definition        = dontCheck (doJailbreak (self.callCabal2nix "luna-api-definition"       ./common/api-definition            {}));
    luna-node-editor-view      = dontCheck (doJailbreak (self.callCabal2nix "luna-node-editor-view"     ./frontend/node-editor-view        {}));
